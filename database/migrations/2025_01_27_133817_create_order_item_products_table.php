...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_item_products', function (Blueprint $table) {
            $table->id();
            $table->foreignId('order_item_id')->constrained('order_items')->onDelete('cascade'); // Relación con ítems
            $table->foreignId('reference_id')->constrained('order_references')->onDelete('cascade'); // Relación con referencias
